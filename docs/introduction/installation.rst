...
To install topicmodels, you can use pip:

.. code-block:: bash

    pip install topicmodels

Note that NumPyro is untested on Windows according to the `Numpyro Installation documentation <https://num.pyro.ai/en/latest/getting_started.html#installation>`_.
