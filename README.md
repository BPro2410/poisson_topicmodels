...
If you want, I can:
- produce a minimal example notebook that runs `run_topicmodels.py` interactively, or
- update the Dockerfile to enable a configurable JUPYTER_TOKEN environment variable.
```// filepath: c:\Users\Bernd\Documents\01_Coding\02_GitHub\topicmodels_package\README.md
# topicmodels_package
