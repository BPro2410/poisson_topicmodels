...
def save_embeds(embeds, path):
    """
    Saves embeddings as .bin file!

    Args:
        embeds: Embedding object
        path: Must contain the .bin ending!
...
def load_embeds(path):
    """
    Reads embeddings from a .bin file

    Args:
        path: Location to the .bin embeddings file

    Returns:
        Embedding object as KeyedVector
